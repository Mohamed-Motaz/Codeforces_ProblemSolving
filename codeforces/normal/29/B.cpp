...
int main() {
    ...
    ld time = d/v;
    ll timeNeededToReachTrafficLight = floor(time);
    if (timeNeededToReachTrafficLight % (ll)(g + r) >= g ){
        //would be present during red light
        time = timeNeededToReachTrafficLight + (g + r - timeNeededToReachTrafficLight % (ll)(g + r));
