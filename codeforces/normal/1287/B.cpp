...
int main() {
    ...
    f(i,0,n){
        f(j, i + 1, n){
            string temp = "";
            f(z, 0, k){
                if (v[i][z] == v[j][z]) temp.push_back(v[i][z]);

                else if (v[i][z] != 'S' && v[j][z] != 'S') temp.push_back('S');
                else if (v[i][z] != 'T' && v[j][z] != 'T') temp.push_back('T');
                else if (v[i][z] != 'E' && v[j][z] != 'E') temp.push_back('E');
