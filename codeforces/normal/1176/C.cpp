...
ll n, a;
ll c4 = 0, c8 = 0, c15 = 0, c16 = 0, c23 = 0, c42 = 0;
int main() {
    MohamedMotaz
    cin >> n;
    vector<ll> v(n);
    f(i,0,n) {
        cin >> a;
        if (a == 4) c4++;
        else if (a == 8 && c4 > c8) c8++;
        else if (a == 15 && c8 > c15) c15++;
        else if (a == 16 && c15 > c16) c16++;
        else if (a == 23 && c16 > c23) c23++;
        else if (a == 42 && c23 > c42) c42++;
    }
    cout << n - c42 * 6 << endl;
}