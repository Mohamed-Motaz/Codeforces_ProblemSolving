...
int main() {
    ...
    cin >> mp["S"] >> mp["M"] >> mp["L"] >> mp["XL"] >> mp["XXL"];
    int k;
    cin >> k;
    f(i, 0, k){
        string a;
        ...
        if (mp[a]) cout << a, mp[a]--;
            ...
            if (a == "S"){
                if (mp["S"]) cout << "S", mp["S"]--;
                else if (mp["M"]) cout << "M", mp["M"]--;
                else if (mp["L"]) cout << "L", mp["L"]--;
                else if (mp["XL"]) cout << "XL", mp["XL"]--;
                else if (mp["XXL"]) cout << "XXL", mp["XXL"]--;
            }if (a == "M"){
                if (mp["M"]) cout << "M", mp["M"]--;
                else if (mp["L"]) cout << "L", mp["L"]--;
                else if (mp["S"]) cout << "S", mp["S"]--;
                else if (mp["XL"]) cout << "XL", mp["XL"]--;
                else if (mp["XXL"]) cout << "XXL", mp["XXL"]--;
