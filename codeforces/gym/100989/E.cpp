...
int main() {
    ...
    if (userPassword.size() == password.size()) {
        ll ans = 0;
        ...
        if (ans == 0 || (ans == 1 && userPassword.size() >= 8)) {
            cout << "yes";
        } else {
            cout << "no";
        }
    ...
    else if ((ll) userPassword.size() - (ll) password.size() == 1 && userPassword.size() >= 8) {
        ll j = 0;
        ll ans = 0;
        for (int i = 0; i < userPassword.size(); i++) {
            if (userPassword[i] != password[j]) {
                ans++;
                j--;
            }
            j++;
