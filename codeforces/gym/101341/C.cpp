...
int main() {
    MohamedMotaz;
    ll red, green, unknown;
    ll mxRed, mxGreen;
    cin >> red >> green >> unknown;
    cin >> mxRed >> mxGreen;
    ll sol1 = llinf, sol2 = llinf;
    ll tot = red + green + unknown;

    //add to red all unknown (assume unknown are red)
    ...
    if (flag1 && flag2) return cout << tot, 0;
    else cout << min({sol1, sol2, tot});
