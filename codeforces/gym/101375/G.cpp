...
int main() {
    ...
    if(mop['A']==max({mop['A'],mop['B'],mop['C'], mop['D']})) cout << 'A';
    else if (mop['B']==max({mop['A'],mop['B'],mop['C'], mop['D']})) cout << "B";
    else if (mop['C']==max({mop['A'],mop['B'],mop['C'], mop['D']})) cout << "C";
    else if (mop['D']==max({mop['A'],mop['B'],mop['C'], mop['D']})) cout << "D";
